...
export class ValidatorServiceGenerated {
    ...
    setValidator = (formControl: SpiderlyFormControl, className: string): SpiderlyValidatorFn => {
        switch(formControl.label + className){
            ...
            case 'primaryColorProject':
                return this.primaryColorProjectValidator(formControl);
            case 'nameProject':
                return this.nameProjectValidator(formControl);
            case 'linkProject':
    ...
    primaryColorProjectValidator = (control: SpiderlyFormControl): SpiderlyValidatorFn => {
        const validator: SpiderlyValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
    ...
    nameProjectValidator = (control: SpiderlyFormControl): SpiderlyValidatorFn => {
        const validator: SpiderlyValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
