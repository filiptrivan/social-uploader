...
export class TranslateLabelsGeneratedService {
    ...
    translate = (name: string): string => {
        switch(name) 
        {
            ...
            case 'unselectedCategoriesIds':
                return this.translocoService.translate('UnselectedCategoriesIds');
            case 'areAllCategoriesSelected':
                return this.translocoService.translate('AreAllCategoriesSelected');
            case 'categoriesTableFilter':
                return this.translocoService.translate('CategoriesTableFilter');
            case 'ipAddress':
